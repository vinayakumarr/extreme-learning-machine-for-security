...
pY1 = os.path.join(curdir, "data/classlabel.txt")
...
result = open("data/result1/sigmulti.txt", "w")
...
result1 = open("data/result1/sigmse.txt", "w")
...
result2 = open("data/result1/rbf12.txt", "w")
...
result3 = open("data/result1/rbf11.txt", "w")
...
result4 = open("data/result1/rbflinf.txt", "w")
...
np.savetxt('data/result1/sigmseother.txt', (fpr,tpr,thresholds), fmt='%10.3f')
print("\n")

print "rbf_12 with multi class error"
elm = hpelm.ELM(42, 2)
elm.add_neurons(22, "rbf_l2")
elm.train(X, Y, 'c')
r3 = elm.predict(X)
print(str(elm))
...
np.savetxt('data/result1/rbf12other.txt', (fpr,tpr,thresholds), fmt='%10.3f')

print("\n")

print "rbf_11 with multi class error"
elm = hpelm.ELM(42, 2)
elm.add_neurons(20, "rbf_l1")
elm.train(X, Y, 'c')
r4 = elm.predict(X)
print(str(elm))
...
np.savetxt('data/result1/rbf11other.txt', (fpr,tpr,thresholds), fmt='%10.3f')
...
np.savetxt('data/result1/rbflinfother.txt', (fpr,tpr,thresholds), fmt='%10.3f')
...
np.savetxt('data/result1/tanhother.txt', (fpr,tpr,thresholds), fmt='%10.3f')
...
np.savetxt('data/result1/linfother.txt', (fpr,tpr,thresholds), fmt='%10.3f')
