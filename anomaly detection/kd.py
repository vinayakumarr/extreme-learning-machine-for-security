...
pX = os.path.join(curdir, "data/anomaly_train.txt")
pY = os.path.join(curdir, "data/class.txt")
pX1 = os.path.join(curdir, "data/train_test.txt")
pY1 = os.path.join(curdir, "data/core.txt")
